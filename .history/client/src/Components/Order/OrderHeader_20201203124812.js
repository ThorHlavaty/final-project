...
export default function OrderHeader() {
  ...
  return (
    <Menu className='menu' inverted fluid color="black" style={{justifyContent:'center', margin:'0', backgroundColor: '#000 !important'}}>
        <Menu.Item
      ...
      <Menu.Item
        ...
        onClick={()=>addGuest()}
                  >
         <div style={{paddingTop:'10px'}}> +Add Guest </div>
      </Menu.Item>   
        <Menu.Item
          name='Previous Guest'
        ...
        <Menu.Item
          ...
          onClick={()=>removeGuest()}
          >
         <div style={{paddingTop:'10px'}}> -Remove Guest</div>
        </Menu.Item>
      </Menu>
